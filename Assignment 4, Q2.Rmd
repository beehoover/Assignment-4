...
ggplot(lb_sz_sum_2, 
       ...
       labs(x = "Sample location", 
            y = "Mean Size (mm)",
            caption = "Bar plot of means for each SITE of a one-way analysis of variance (ANOVA).  Error indicates standard diviation of the mean.  Bars sharing the same letter are not significantly different according to Tukey’s HSD test.")  +
